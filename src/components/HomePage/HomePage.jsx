...
import {
  BsFilter, BsThreeDotsVertical, BsEmojiSmile, BsMicFill,
} from 'react-icons/bs';
...
const HomePage = () => {
  ...
  return (
    <div className="relative bg-slate-400">
      <div className=" top-0  py-14 bg-[#035193] w-full " />
          ...
          <div className="w-full">
            ...
            <div className="flex justify-between items-center p-3">
              ...
              <div className="space-x-3 text-2xl flex">
                <TbCircleDashed className="cursor-pointer" onClick={() => history.push('/status')} />
                <BiCommentDetail />
        ...
        {!currentChat && (
          <div className="w-[70%] flex flex-col items-center justify-center h-full ">
            <div className="max-w-[70%]  text-center">
              <img src="https://cdn.pixabay.com/photo/2018/04/27/11/13/group-3354366_640.png" alt="" />
            </div>
